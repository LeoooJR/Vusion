...
class Program:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('-R', '--rescue', action='store_true', required=False, help='Rescue rejected calls')
        self.parser.add_argument('-H', '--hotspot', action='store_true', required=False, help='Combine two combined callsets; \
